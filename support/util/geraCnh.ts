...
class Gera_Cnh {
    ...
    //Retorna CNH valida
    public geraCnhValida() {
        do {
            var cnh: any = GeraCnh.CNH();
        ...
        toFile = path.join(__dirname, '../../support/util/gravados/cnh.json');
