...
class RetornaDataAtual {
    ...
    public retornarDataHojeSformat() {
        data = new Date();
        dia = data.getDate();
        dia_sem = data.getDay();
    ...
    public adicionarDiaEmDataOferta(dias) {
    ...
    public addDiaEmDataSemFormat(dias) {
    ...
    public retornarMesAnoAtualText() {
        data = new Date();
        mes = data.getMonth();
