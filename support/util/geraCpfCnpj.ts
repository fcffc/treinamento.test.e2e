...
class Gera_CPF_CNPJ {
    ...
    public cpf() {
        ...
        toFile = path.join(__dirname, '../../support/util/gravados/cpf.json');
    ...
    public cnpjUnidadeVeicular() {
        ...
        toFile = path.join(__dirname, '../../support/util/gravados/cnpj.json');
        stringFile = toFile.toString();
        fs.writeFile(stringFile, data, (err) => {
            if (err) throw err;
        });
...
//     public Gera_CPF_CNPJ(data, cpfGravado, cpfG, toFile, stringFile, cpfs, result2) {
//         this.data = data;
...
//     public setCpfGravado(cpfGravado) {
//         this.cpfGravado = cpfGravado;
//     }

//     public getCpfGravado(cpfGravado) {
//         return cpfGravado;
//     }
...
//     public setToFile(toFile) {
//         this.toFile = toFile;
//     }

//     public getToFile(toFile) {
//         return toFile;
//     }

//     public setStringFile(stringFile) {
//         this.stringFile = stringFile;
//     }

//     public getStringFile(stringFile) {
//         return stringFile;
//     }
