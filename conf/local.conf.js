...
const capabilities = debug
    ? [{ browserName: (process.env.TEST_BROWSER_NAME || 'chrome'), 'goog:chromeOptions': { args: ['--window-size=1800,1500'] }, maxInstances: 1 }]
    : [
        {
...
exports.config = {
    ...
    specs: [
        ...
        // API LE
        // './features/api/loteEmbarcador/geraLoteEmbarcador.feature',

        // API Viagem

        // Treinamento - perfil geral
        './features/treinamento/logarDeslogar.feature',
    ],
    // Patterns to exclude.
    exclude: [
